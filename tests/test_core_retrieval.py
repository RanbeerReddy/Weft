...
def test_core_retrieval_path():
    ...
    try:
        ...
        unique_query = "How to FLUBBERGAST_DEPLOYMENT_OF_MOCK_DOCKER_CONTAINER_12345_XYZ?"
        ...
        mem = Memory(
            ...
            embedding_vector=list(model.encode(unique_target, normalize_embeddings=True)),
        )
        db.merge(mem)
        db.commit()
