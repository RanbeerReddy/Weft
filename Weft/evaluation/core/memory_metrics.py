...
class MemoryEvaluationSummary:
    ...
    def compute_rates(self):
        ...
        self.candidate_recall_at_10_rate = self.queries_with_candidate_recall_at_10 / self.total_queries
        self.candidate_recall_at_20_rate = self.queries_with_candidate_recall_at_20 / self.total_queries
        self.candidate_recall_at_50_rate = self.queries_with_candidate_recall_at_50 / self.total_queries
...
class MemoryMetricsCalculator:
    ...
    @staticmethod
    def find_phrase_rank(phrase: str, retrieved_chunks: List[MemoryRetrievalResult], 
                        max_rank: int = 50) -> Optional[int]:
        ...
        for chunk in retrieved_chunks[:max_rank]:
            if MemoryMetricsCalculator.phrase_in_text(normalized_phrase, chunk.chunk_text):
                return chunk.rank
        
        return None
    
    @staticmethod
    def calculate_memory_hit_at_k(retrieved_chunks: List[MemoryRetrievalResult],
                                  expected_phrase: str,
                                  k: int) -> bool:
        ...
        """
        rank = MemoryMetricsCalculator.find_phrase_rank(expected_phrase, retrieved_chunks, max_rank=k)
        return rank is not None
    
    @staticmethod
    def calculate_phrase_mrr(retrieved_chunks: List[MemoryRetrievalResult],
                            expected_phrase: str) -> float:
        ...
        """
        rank = MemoryMetricsCalculator.find_phrase_rank(expected_phrase, retrieved_chunks, max_rank=50)
    ...
    @staticmethod
    def evaluate_memory_query(query: str, expected_phrase: str, 
                             retrieved_chunks: List[MemoryRetrievalResult],
                             query_type: Optional[str] = None) -> MemoryQueryMetrics:
        ...
        phrase_rank = MemoryMetricsCalculator.find_phrase_rank(expected_phrase, retrieved_chunks, max_rank=50)
        
        # Calculate memory hits
        memory_hit_at_1 = MemoryMetricsCalculator.calculate_memory_hit_at_k(retrieved_chunks, expected_phrase, 1)
        memory_hit_at_3 = MemoryMetricsCalculator.calculate_memory_hit_at_k(retrieved_chunks, expected_phrase, 3)
        memory_hit_at_5 = MemoryMetricsCalculator.calculate_memory_hit_at_k(retrieved_chunks, expected_phrase, 5)
        memory_hit_at_10 = MemoryMetricsCalculator.calculate_memory_hit_at_k(retrieved_chunks, expected_phrase, 10)
        ...
        # Calculate MRR
        phrase_mrr = MemoryMetricsCalculator.calculate_phrase_mrr(retrieved_chunks, expected_phrase)
